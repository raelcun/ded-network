...
Command.createMessageReq = ({ sourceContact, destContact, state }) =>
	Command.createCommand({ sourceContact, destContact, strCommand: 'MESSAGE', payload: { state }})

Command.createMessageRes = ({ sourceContact, destContact, orgRequestId, state }) =>
	Command.createCommand({ sourceContact, destContact, strCommand: 'MESSAGE_RESPONSE', id: orgRequestId, payload: {state}})

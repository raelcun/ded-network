    ...
    const handleCommand = (data) => {
      ...
      switch(command.command)
      {
        ...
        case 'MESSAGE':
          ...
          console.log(`received ${command.payload.messageString}`);
        ...
        case 'FIND':
          // TODO: save pubkey
          console.log(`found ${command.payload.publicKey}`);
          ...
          sendCommand(Command.createFindRes(command.id, node, command.payload.sourceId, command.payload.sourceIP, command.payload.sourcePort, '67890'));
          break;
        case 'FIND_RESPONSE':

...
Command.createRetrieveContactsReq = ({ sourceContact, destContact, state }) =>
	Command.createCommand({ sourceContact, destContact, strCommand: 'RETRIEVE_CONTACTS', payload: {
		state
	}})

Command.createRetrieveContactsRes = ({ sourceContact, destContact, orgRequestId, state }) =>
	Command.createCommand({ sourceContact, destContact, id: orgRequestId, strCommand: 'RETRIEVE_CONTACTS_RESPONSE', payload: {
		state
	}})
